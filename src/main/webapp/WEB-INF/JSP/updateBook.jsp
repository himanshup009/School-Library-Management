...
<head>
    ...
    <title>Update Book - BookLedger</title>
...
<body>
    ...
    <div class="form-container">
        <div class="form-header">
            ...
            <h1>Update Book</h1>
            <p>Edit the details of "${book.name}"</p>
        </div>
        ...
        <form method="post" action="/library/updateBook">
            ...
            <div class="form-group">
                <label for="status"><i class="fas fa-info-circle"></i> Status 
                    <span class="status-preview ${book.status == 'available' ? 'status-available' : 'status-borrowed'}">
                        ${book.status}
                    </span>
                </label>
                <div class="input-with-icon">
            ...
            <div class="form-buttons">
                ...
                <a href="/library/display" class="btn btn-secondary">
